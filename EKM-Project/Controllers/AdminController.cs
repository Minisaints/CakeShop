...
namespace EKM_Project.Controllers
{
    ...
    public class AdminController : Controller
    {
        ...
        [HttpPost]
        [Authorize]
        public ActionResult EditCake([Bind(Include = "Id,CakeName,CakeDescription,Price,Image")] Cake _cake, HttpPostedFileBase UploadedImage)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                else
                {
                    ...
                    var find = _context.Cakes.First(c => c.Id == _cake.Id).Image;
                    _cake.Image = find;
                    _context.Set<Cake>().AddOrUpdate(_cake);
                }
